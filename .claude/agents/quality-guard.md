...
1. `.claude/tasks.md` — ta tâche et les dépendances (attendre que python-architect soit DONE)
...
- Coverage < 80% → `Status: REJECTED` + note dans `.claude/tasks.md` + notifier Orchestrator

## Si REJECT

Écrire dans `.claude/tasks.md` :
